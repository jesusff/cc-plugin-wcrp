...
def check_calendar_recommendation(ds, severity=BaseCheck.MEDIUM):
    """
    ...
    Note: this is a recommendation only. The validity of the calendar value
    itself is checked separately by the ATTR enum check on the calendar
